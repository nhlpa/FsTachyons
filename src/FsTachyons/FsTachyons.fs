...
type TachyonsClass =  TachyonsClass of string

let tac (TachyonsClass x) = x

type TachyonsClass with
    static member (+) (a, b : TachyonsClass) =
        TachyonsClass (String.Join(" ", [tac a; tac b]))
